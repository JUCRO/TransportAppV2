...
import com.example.androiduberriderremake.Model.RiderModel;
...
public class SplashScreenActivity extends AppCompatActivity {
    ...
    private void ShowRegisterLayout() {
        ...
        TextInputEditText imsj_first_name = (TextInputEditText)itemView.findViewById(R.id.edt_first_name);
        TextInputEditText imsj_last_name = (TextInputEditText)itemView.findViewById(R.id.edt_last_name);
        TextInputEditText imsj_phone = (TextInputEditText)itemView.findViewById(R.id.edt_phone_number);
        ...
        if(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber() != null &&
            ...
            imsj_phone.setText(FirebaseAuth.getInstance().getCurrentUser().getPhoneNumber());
        ...
        btn_continue.setOnClickListener(view -> {
            if(TextUtils.isEmpty(imsj_first_name.getText().toString()))
            {
                Toast.makeText(this,"Por favor ingrese su nombre", Toast.LENGTH_SHORT).show();
                return;
            }
            else if(TextUtils.isEmpty(imsj_last_name.getText().toString())) {
                Toast.makeText(this, "Por favor ingrese su apellido", Toast.LENGTH_SHORT).show();
                return;
            }
            else if(TextUtils.isEmpty(imsj_phone.getText().toString())) {
                Toast.makeText(this, "Por favor ingrese su numero celular", Toast.LENGTH_SHORT).show();
            ...
            else
            {
                ...
                model.setFirstName(imsj_first_name.getText().toString());
                model.setLastName(imsj_last_name.getText().toString());
                model.setPhoneNumber(imsj_phone.getText().toString());
